...
const contactInfo = [
  { icon: LuMail,   label: "Email",    value: "yazan.chaya73@gmail.com", href: "mailto:yazan.chaya73@gmail.com" },
  { icon: FaPhone,  label: "Phone",    value: "+963994701005",            href: "tel:+963994701005" },
  { icon: FaMapPin, label: "Location", value: "As Suwayda, Syria",        href: "#" },
];
    ...
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span data-aos="fade-down" className="text-secondary-foreground text-sm font-medium tracking-wider uppercase">
            Get In Touch
          </span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div data-aos="fade-right" data-aos-delay="200" className="glass p-8 rounded-3xl border border-primary/30">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <Button className="w-full" type="submit" size="lg" disabled={isLoading}>
                {isLoading ? <>Sending...</> : <><LuSend className="w-5 h-5" />Send Message</>}
              </Button>
              {submitStatus.type && (
          ...
          <div data-aos="fade-left" data-aos-delay="300" className="space-y-6">
            ...
            <div data-aos="flip-up" data-aos-delay="400" className="glass rounded-3xl p-8 border border-primary/30">
